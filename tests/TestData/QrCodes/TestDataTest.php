...
class TestDataTest extends TestCase
{
    ...
    public function qrFileProvider(): array
    {
        return [
            ...
            [__DIR__ . '/qr-payment-information-with-mediumlong-creditor-and-unknown-debtor.png', '1da10251b49d72aa48c35207f54d4f1e'],
            [__DIR__ . '/qr-payment-information-without-amount-and-long-addresses.png', '7f0276efa720448229a0cbeccc2aa805'],
            [__DIR__ . '/qr-payment-information-without-amount.png', 'd779c23775b755e7d193b22e93b51ed4'],
            [__DIR__ . '/qr-payment-information-without-amount-but-debtor.png', '176a87b6743ebb3b4d15e9d85937780a'],
